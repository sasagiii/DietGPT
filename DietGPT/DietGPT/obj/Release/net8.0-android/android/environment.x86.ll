...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 102867626, ; hash 0x621a2aa, from name: aot-DietGPT
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1022338078, ; hash 0x3cefa41e, from name: DietGPT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	...
	%struct.DSOCacheEntry {
		i64 1469285201, ; hash 0x57938351, from name: aot-DietGPT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 158
	...
	%struct.DSOCacheEntry {
		i64 2492968885, ; hash 0x9497afb5, from name: libaot-DietGPT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 278
	...
	%struct.DSOCacheEntry {
		i64 3226475881, ; hash 0xc0501d69, from name: DietGPT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 372
	...
	%struct.DSOCacheEntry {
		i64 3460287711, ; hash 0xce3fccdf, from name: libaot-DietGPT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
