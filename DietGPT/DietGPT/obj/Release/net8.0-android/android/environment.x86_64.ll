...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1700980030461216242, ; hash 0x179b185355ac85f2, from name: DietGPT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4919704286904649616, ; hash 0x44464cfbb4eb0790, from name: aot-DietGPT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	...
	%struct.DSOCacheEntry {
		i64 6036759789928651997, ; hash 0x53c6e10b790f1cdd, from name: libaot-DietGPT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 137
	...
	%struct.DSOCacheEntry {
		i64 10431713690115432426, ; hash 0x90c4e454e1e8dfea, from name: libaot-DietGPT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 12973431229143036442, ; hash 0xb40ae2f77b07b21a, from name: DietGPT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 333
	...
	%struct.DSOCacheEntry {
		i64 14211998369834596795, ; hash 0xc53b29380e6bf9bb, from name: aot-DietGPT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-DietGPT.dll.so
		ptr null; void* handle (0x0)
	}, ; 375
...
@.env.3 = private unnamed_addr constant [37 x i8] c"aea113cf-5715-4e22-ba24-41a75aeb1765\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.dietgpt\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-DietGPT.dll.so\00", align 16
